...
if n == 24:
    ...
    list1_len = int(input('Введите число элементов в массиве: '))
   
    for i in range(list1_len):
        list1.append(int(randint(0,99)))
    ...
    for i in range(list1_len):
        if i == 0:
            sum = list1[i] + list1[list1_len - 1] + list1[i+1]
        elif i == list1_len - 1:
            sum = list1[i] + list1[i-1] + list1[0]
        else:
